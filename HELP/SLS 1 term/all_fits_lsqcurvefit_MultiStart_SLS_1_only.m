function all_fits_lsqcurvefit_MultiStart_SLS_1_only(data,name,i)
    ...
    % Set initial guess for the model parameters
    p_init_SLS_1 = [1 1 10000];  %(A, B, tau), SLS 1-term
    ...
    %SLS-1 term
    problem_SLS_1 = createOptimProblem('lsqcurvefit','x0',p_init_SLS_1,'objective',@SLS_relax_Funct_General_1_term,...
    'lb',[0, 0, 0],'ub',[],'xdata',Step_time,'ydata',Normalized_Stress_G);
    ...
    relax_fit_SLS = SLS_relax_Funct_General_1_term(p_fit_SLS_1, time_fit_SLS);
