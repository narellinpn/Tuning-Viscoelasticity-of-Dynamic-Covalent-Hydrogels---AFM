%Free Fits in SLS general 1 term
%Load all data
...
%all_fit_data_cells_lsqcurvefit(data_20k_6BZA, '20kDa HA 6% BZA @ 10% Strain - Set Tau');
all_fit_data_cells_lsqcurvefit(data_20k_12BZA, '20kDa HA 12% BZA @ 10% Strain - Free fit');
all_fit_data_cells_lsqcurvefit(data_20k_20BZA, '20kDa HA 20% BZA @ 10% Strain - Free fit');

all_fit_data_cells_lsqcurvefit(data_40k_12BZA, '40kDa HA 12% BZA @ 10% Strain - Free fit');

all_fit_data_cells_lsqcurvefit(data_60k_12BZA, '60kDa HA 12% BZA @ 10% Strain - Free fit');
all_fit_data_cells_lsqcurvefit(data_60k_6BZA, '60kDa HA 6% BZA @ 10% Strain - Free fit');
all_fit_data_cells_lsqcurvefit(data_60k_20BZA, '60kDa HA 20% BZA @ 10% Strain - Free fit');

all_fit_data_cells_lsqcurvefit(data_100k_12BZA, '100kDa HA 12% BZA @ 10% Strain - Free fit');

all_fit_data_cells_lsqcurvefit(data_500k_12BZA, '500kDa HA 12% BZA @ 10% Strain - Free fit');
all_fit_data_cells_lsqcurvefit(data_500k_6BZA, '500kDa HA 6% BZA @ 10% Strain - Free fit');
all_fit_data_cells_lsqcurvefit(data_500k_20BZA, '500kDa HA 20% BZA @ 10% Strain - Free fit');

all_fit_data_cells_lsqcurvefit(data_1000k_12BZA, '1000kDa HA 12% BZA @ 10% Strain - Free fit');