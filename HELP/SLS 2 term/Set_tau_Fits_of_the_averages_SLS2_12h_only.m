...
% %Set tau from Moduli with q Fits in SLS general 2 term
all_fit_data_cells_lsqcurvefit_set_tau_Funct_SLS_2(data_20k_12BZA, '20kDa HA 12% BZA - SLS 2 - Set Tau');
all_fit_data_cells_lsqcurvefit_set_tau_Funct_SLS_2(data_20k_20BZA, '20kDa HA 20% BZA - SLS 2 - Set Tau');

all_fit_data_cells_lsqcurvefit_set_tau_Funct_SLS_2(data_40k_12BZA, '40kDa HA 12% BZA - SLS 2 - Set Tau');

all_fit_data_cells_lsqcurvefit_set_tau_Funct_SLS_2(data_60k_12BZA, '60kDa HA 12% BZA - SLS 2 - Set Tau');
all_fit_data_cells_lsqcurvefit_set_tau_Funct_SLS_2(data_60k_6BZA, '60kDa HA 6% BZA - SLS 2 - Set Tau');
all_fit_data_cells_lsqcurvefit_set_tau_Funct_SLS_2(data_60k_20BZA, '60kDa HA 20% BZA - SLS 2 - Set Tau');

all_fit_data_cells_lsqcurvefit_set_tau_Funct_SLS_2(data_100k_12BZA, '100kDa HA 12% BZA - SLS 2  - Set Tau');



all_fit_data_cells_lsqcurvefit_set_tau_Funct_SLS_2(data_500k_12BZA, '500kDa HA 12% BZA - SLS 2 -Set Tau');
all_fit_data_cells_lsqcurvefit_set_tau_Funct_SLS_2(data_500k_6BZA, '500kDa HA 6% BZA - SLS 2 -Set Tau');
all_fit_data_cells_lsqcurvefit_set_tau_Funct_SLS_2(data_500k_20BZA, '500kDa HA 20% BZA - SLS 2 -Set Tau');

all_fit_data_cells_lsqcurvefit_set_tau_Funct_SLS_2(data_1000k_12BZA, '1000kDa HA 12% BZA - SLS 2  - Set Tau');