function all_fit_data_cells_lsqcurvefit_set_tau_Funct_SLS_2(dataCell,name)
...
for i = 1:numel(dataCell)
    ...
    all_fits_lsqcurvefit_MultiStart_SLS_2_only_set_tau_Funct(data_to_fit,currentName,i);
