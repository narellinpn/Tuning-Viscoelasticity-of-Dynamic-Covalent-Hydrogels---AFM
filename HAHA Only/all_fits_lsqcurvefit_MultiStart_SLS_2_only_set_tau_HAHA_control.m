function all_fits_lsqcurvefit_MultiStart_SLS_2_only_set_tau_HAHA_control(data,name,i)
    ...
    if contains(name,'20k')
            funct_MW=@SLS_relax_Funct_General_2_term_Set_Tau_HAHA_60k_hyd_20k_12h;

    elseif contains(name,'60k') 
            funct_MW=@SLS_relax_Funct_General_2_term_Set_Tau_HAHA_60k_hyd_60k_12h;

    elseif contains(name,'500k')
            funct_MW=@SLS_relax_Funct_General_2_term_Set_Tau_HAHA_60k_hyd_500k;
    elseif contains(name,'1000k')
            funct_MW=@SLS_relax_Funct_General_2_term_Set_Tau_HAHA_60k_hyd_1000k;
    end
